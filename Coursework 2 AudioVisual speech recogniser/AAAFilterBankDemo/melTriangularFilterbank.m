function [fbank] = melTriangularFilterbank(magSpec, numFilters, frameLength)
...
eachMelIndex = zeros(1, numFilters+1);  %Array for every index point
...
for i = 2:numFilters        %rest of coordinates/index
...
for i = 1:numFilters
    ...
    rightCorner = eachMelIndex(i+1);       %end point of triangle base
